...
void MultiLevelsLeftDown1Window()
{
    ImGui::PushStyleVar(ImGuiStyleVar_WindowRounding, 6.f);
    ImGui::Begin("Left-Down1 Window", nullptr, TestWindowFlag);
...
void MultiLevelsLeftDown2Window()
{
    ImGui::PushStyleVar(ImGuiStyleVar_WindowRounding, 6.f);
    ImGui::Begin("Left-Down2 Window", nullptr, TestWindowFlag);
...
void MultiLevelsRightDownWindow()
{
    ImGui::PushStyleVar(ImGuiStyleVar_WindowRounding, 6.f);
...
// A 3 levels layout.
DearImGuiExt::CustomLayoutNode* MultiLevelsLayout()
{
...
int main(int, char**)
{
    ...
    DearImGuiExt::CustomLayout myLayout(MultiLevelsLayout());
